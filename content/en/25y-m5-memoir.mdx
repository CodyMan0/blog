...
I used that time to go through courses on GitHub Actions and Docker, watch lectures on OOP, and read through the first half of _The Art of Unit Testing_.
...
- [ ] Read _Objects and Roles: A Gentle Introduction to Object-Oriented Programming_ and write up thoughts
- [ ] Finish _The Art of Unit Testing_ and write up thoughts -> Start with the easiest frontend logic and apply unit tests!
