...
last_update:
  date: 3/14/2025
description: FSD를 사내에 적용해본 경험을 공유합니다.
tags: [FSD]
---

![img alt="refacts"](/img/study/fsd-refacts.png)
...
![img alt="refacts"](/img/study/fsd-error.png)

![img alt="refacts"](/img/study/fsd-error-2.png)
...
![img alt="model"](/img/study/fsd-model.png)
(백엔드 모델 일부)

위와 프론트 슬라이스를 비슷하게 가져가면 됩니다.

![img alt="front"](/img/study/fsd-front.png)
...
![img alt="domain"](/img/study/fsd-domain.png)
