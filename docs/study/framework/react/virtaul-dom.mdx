---
title: 가상돔 직접 구현해서 확인해보자.
sidebar_position: 3
last_update:
  date: 03/11/2025
description: 머리로 알고 있는 것과 구현하는 것은 다르다...
tags: [스터디, 회고]
---
...
[브라우저 렌더링 과정](https://lee2022.com/blog/critical-rendering-path)을 잠시 잊었다면, 해당 포스트가 도움이 됩니다. 이를 기반으로 가상돔이 어떤 문제를 해결하고자 했는지 더욱 이해할 수 있습니다.
